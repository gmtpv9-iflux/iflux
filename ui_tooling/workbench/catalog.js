...
(function () {
  ...
  var PAGE_SIZE = 48;
  var COMPONENT_CSS = [
    '/design_system/04_components/03_card/card.css',
    '/design_system/04_components/13_stat/stat.css',
    '/design_system/04_components/13_stat/stat-strip.css',
    '/design_system/04_components/02_breadcrumb/breadcrumb.css',
    '/design_system/04_components/08_form/form.css',
    '/design_system/04_components/14_table/table.css',
    '/design_system/04_components/11_pagination/pagination.css',
    '/design_system/04_components/06_drawer/drawer.css',
    '/design_system/04_components/01_action-bar/action-bar.css',
    '/design_system/04_components/09_modal/modal.css',
    '/design_system/04_components/17_toast/toast.css',
    '/design_system/04_components/07_dropdown/dropdown.css',
    '/design_system/04_components/15_tabs/tabs.css',
    '/design_system/04_components/12_search/search.css',
    '/design_system/04_components/16_timeline/timeline.css',
  ...
  var COMPONENT_JS = [
    ...
    '/design_system/04_components/11_pagination/pagination.js',
    '/design_system/04_components/06_drawer/drawer.js',
    '/design_system/04_components/09_modal/modal.js',
    '/design_system/04_components/17_toast/toast.js',
    '/design_system/04_components/07_dropdown/dropdown.js',
    '/design_system/04_components/15_tabs/tabs.js',
    '/design_system/04_components/08_form/form.js',
  ...
  function bindComponents() {
    if (window.IfxTable) {
      doc.querySelectorAll('[data-ifx-table]').forEach(function (el) { window.IfxTable.init(el); });
    }
    if (window.IfxPagination) {
    ...
    var pagDemo = doc.getElementById('sbPagDemo');
    if (pagDemo && window.IfxPagination && pagDemo.getAttribute('data-sb-pag') !== '1') {
      pagDemo.setAttribute('data-sb-pag', '1');
      window.IfxPagination.render(pagDemo, { page: 1, pages: 5, total: 48 });
      pagDemo.addEventListener('ifx-page-change', function (e) {
        window.IfxPagination.render(pagDemo, { page: e.detail.page, pages: 5, total: 48 });
      });
    }
  }
  var PRIMITIVE_CSS = [
    ...
    '/design_system/03_primitives/03_badge/badge.css',
    '/design_system/03_primitives/02_avatar/avatar.css',
    '/design_system/03_primitives/01_alert/alert.css',
    '/design_system/03_primitives/07_progress/progress.css',
    '/design_system/03_primitives/06_navigation/nav.css',
    '/design_system/03_primitives/08_title/title.css'
  ];
  ...
  function showPanel(id) {
    var panels = stage.querySelectorAll('[data-sb-panel]');
    if (!panels.length) return;
    var target = id ? stage.querySelector('[data-sb-panel="' + id + '"]') : null;
    if (!target) target = stage.querySelector('[data-sb-panel]');
    panels.forEach(function (p) { p.hidden = p !== target; });
    var active = target.getAttribute('data-sb-panel');
  ...
  function bindIcons() {
    ...
    fetch('/vendor/tabler/icon-index.json')
  ...
  function afterSection(id, panel) {
    ...
    ensureHref('/design_system/03_primitives/08_title/title.css', 'css');
