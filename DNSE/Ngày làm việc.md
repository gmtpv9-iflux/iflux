...
<span id="getMarketWorkingDates"></span>

### `GET /market/working-dates`

Truy vấn danh sách ngày làm việc (ngày giao dịch) của thị trường chứng khoán trong vòng 1 năm tính từ ngày hiện tại, đã loại trừ các ngày nghỉ lễ và cuối tuần.

<h3 id="getmarketworkingdates-parameters">Parameters</h3>
...
curl -X GET https://openapi.dnse.com.vn/market/working-dates \
...
```http
GET https://openapi.dnse.com.vn/market/working-dates HTTP/1.1
...
func main() {
    ...
    req, err := http.NewRequest("GET", "https://openapi.dnse.com.vn/market/working-dates", data)
    req.Header = headers
...
fetch('https://openapi.dnse.com.vn/market/working-dates',
{
  method: 'GET',
...
r = requests.get('https://openapi.dnse.com.vn/market/working-dates', headers = headers)
...
```java
URL obj = new URL("https://openapi.dnse.com.vn/market/working-dates");
...
<h3 id="getmarketworkingdates-responseschema">Response Schema</h3>

Status Code **200**

|Name|Type|Required|Restrictions|Description|
|---|---|---|---|---|
|» workingDates|[string]|false|none|Danh sách ngày làm việc|
