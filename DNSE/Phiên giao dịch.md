...
|tscProdGrpId|query|string|true|Nhóm sản phẩm theo thị trường|
...
curl -X GET https://openapi.dnse.com.vn/market/trading-session?tscProdGrpId=STO \
...
```http
GET https://openapi.dnse.com.vn/market/trading-session?tscProdGrpId=STO HTTP/1.1
...
fetch('https://openapi.dnse.com.vn/market/trading-session?tscProdGrpId=STO',
{
  method: 'GET',
...
r = requests.get('https://openapi.dnse.com.vn/market/trading-session', params={
  'tscProdGrpId': 'STO'
}, headers = headers)
...
```java
URL obj = new URL("https://openapi.dnse.com.vn/market/trading-session?tscProdGrpId=STO");
...
<h1 id="dnse-openapi-v2-broker">broker</h1>
