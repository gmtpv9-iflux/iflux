...
(function (global) {
  ...
  /** UI lock only — path capture flag; not the same as readActive() (cookie/LS fallback). */
  function isPathCapturedAttribution() {
    try {
      return global.localStorage.getItem(REF_FROM_LINK_KEY) === '1';
    } catch (e) {
      return false;
    }
  }
  ...
  global.IfluxAffiliateResolver = {
    ...
    isPathCapturedAttribution: isPathCapturedAttribution,
