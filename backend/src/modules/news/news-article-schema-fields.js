...
/**
 * SoT — schema field keys của bài Cộng đồng (news_posts.payload + cột bảng).
 ...
 *
 * mapping RSS (cafef/vietstock/baodautu/note) lưu trong news_rss_schema.mapping_json.
 */
...
const ARTICLE_SCHEMA_FIELDS = [
  ...
  { key: 'updated_at', label: 'Ngày cập nhật', group: 'lifecycle', cafef: 'dateModified', vietstock: 'article:modified_time', baodautu: '', note: 'Cột bảng news_posts (+ payload mirror nếu có)' },
  ...
  { key: 'id', label: 'id (PK)', group: 'system', cafef: '', vietstock: '', baodautu: '', note: 'Cột bảng news_posts' },
