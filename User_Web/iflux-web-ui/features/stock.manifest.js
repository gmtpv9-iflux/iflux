...
var manifest = {
  ...
  modules: [
    ...
    m('community-store', 'store', ASSET + 'news-store.js?v=feedDto20260724', 'IfluxNewsStore'),
    m('community-api-bridge', 'js', ASSET + 'iflux-news-api-bridge.js?v=feedDto20260724', 'IfluxNewsApiBridge'),
    ...
    m('community-daily-feed', 'js', ASSET + 'news-daily-feed.js?v=entFeed20260724', 'IfluxDailyFeed'),
