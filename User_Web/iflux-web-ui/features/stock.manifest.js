...
var manifest = {
  ...
  modules: [
    ...
    m('entity-detail-center', 'js', ASSET + 'entity-detail-center.js?v=entFeed20260724', 'IfluxEntityDetailCenter'),
    m('stock-page', 'js', ASSET + 'stock-page.js?v=entFeed20260724', 'IfluxStockPage'),
