...
export async function mount(el, ctx) {
  ...
  await ensureSequence([
    ...
    { global: 'IfluxNewsStore', src: ASSET + 'news-store.js' },
    ...
    { global: 'IfluxCommunityTrending', src: ASSET + 'news-trending.js?v=' + V }
  ]);

  if (!window.IfluxCommunityTrending || typeof IfluxCommunityTrending.mountInto !== 'function') {
    el.innerHTML = '<div class="ifx-wl-empty">Thiếu news-trending.js</div>';
    return;
  }
