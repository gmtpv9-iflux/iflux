 ...
 * Page Feature: title + intro + bảng main → Layout Engine mount placements vào Host.
 */
...
/**
 * Host sidebar + main (Widget Area) — bảng entity ở [data-elp-main] = Page Feature,
 * không gắn data-ifx-section lên bảng.
 */
var LAYOUT_HTML =
...
/** Runtime kind → PagePublished key (PAGE_REGIONS). */
function publishKeyForKind(kind) {
  return kind === 'chu-de' ? 'chu-de' : kind;
}
