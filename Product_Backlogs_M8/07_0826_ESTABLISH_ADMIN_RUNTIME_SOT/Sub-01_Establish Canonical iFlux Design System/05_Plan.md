...
**Hiện tại:** P6-W10 OPEN. P6a OPEN — `typography.css` Phase A plan chờ Owner Gate A. Evidence `gates/P6.md` + `gates/P6-W10.md` + `gates/P6a_CSS_Ownership_Scope_Normalization/`.
