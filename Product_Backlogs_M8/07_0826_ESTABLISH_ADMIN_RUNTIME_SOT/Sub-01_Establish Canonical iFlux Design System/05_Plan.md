...
| Trạng thái | **P1–P4 = OWNER PASS** · **P6-W01 + Sandbox Normalization = LOCKED** · **P6-W02 = OPEN** · W03–W10 BLOCKED |
...
**Hiện tại:** P6-W02 OPEN. Evidence `gates/P6.md` + `gates/P6-W02.md`.

**Owner test (UI):** mở cạnh nhau — không iframe.

- Candidate: https://staging.iflux.vn/design_system/references/patterns/form-add/
- Legacy: https://staging.iflux.vn/Admin_Design_system/patterns/form-add.html
