...
| Trạng thái | **P1–P4 = OWNER PASS** · **P6-W01 + Sandbox + W02–W07 = LOCKED** · **P6-W08 = OPEN** · W09–W10 BLOCKED |
...
**Hiện tại:** P6-W08 OPEN. Evidence `gates/P6.md` + `gates/P6-W08.md`.

**Owner test (UI):** mở cạnh nhau — không iframe.

- Candidate: https://staging.iflux.vn/design_system/references/patterns/referrals/
- Legacy: staging.iflux.vn + path Admin_Design_system/patterns/referrals.html
