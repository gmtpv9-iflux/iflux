...
| Trạng thái | **P1–P4 = OWNER PASS** · **P6-W01 + Sandbox + W02 = LOCKED** · **P6-W03 = OPEN** · W04–W10 BLOCKED |
...
**Hiện tại:** P6-W03 OPEN. Evidence `gates/P6.md` + `gates/P6-W03.md`.

**Owner test (UI):** mở cạnh nhau — không iframe.

- Candidate: https://staging.iflux.vn/design_system/references/patterns/order-list/
- Legacy: https://staging.iflux.vn/Admin_Design_system/patterns/order-list.html
