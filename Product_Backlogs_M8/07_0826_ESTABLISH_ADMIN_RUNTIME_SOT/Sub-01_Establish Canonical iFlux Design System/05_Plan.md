...
| Trạng thái | **P1–P4 = OWNER PASS** · **P6-W01 + Sandbox + W02 + W03 + W04 + W05 + W06 = LOCKED** · **P6-W07 = OPEN** · W08–W10 BLOCKED |
...
**Hiện tại:** P6-W07 OPEN. Evidence `gates/P6.md` + `gates/P6-W07.md`.

**Owner test (UI):** mở cạnh nhau — không iframe.

- Candidate: https://staging.iflux.vn/design_system/references/patterns/chat/
- Legacy: staging.iflux.vn + path Admin_Design_system/patterns/chat.html
