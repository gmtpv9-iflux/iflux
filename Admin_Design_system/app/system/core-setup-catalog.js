/**
 * ADM-SYS-010 — Thiết lập core (nhịp update · giờ giao dịch)
 */
(function (global) {
  'use strict';

  var STORAGE_KEY = 'iflux_core_config_v1';
  ...
  function saveConfig(partial) {
    ...
    if (typeof document !== 'undefined') {
      document.dispatchEvent(new CustomEvent('iflux-core-config-changed', { detail: next }));
    }
    return next;
  }
