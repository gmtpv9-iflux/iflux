...
(function () {
  ...
  function openModal(mode, id) {
    ...
    if (mode === 'new') {
      ...
      if (saveBtn) {
        saveBtn.style.display = canPerm('community.rss_providers.create') ? '' : 'none';
        saveBtn.setAttribute('data-ix-perm', 'community.rss_providers.create');
      }
    } else {
      ...
      if (saveBtn) {
        saveBtn.style.display = canPerm('community.rss_providers.edit') ? '' : 'none';
        saveBtn.setAttribute('data-ix-perm', 'community.rss_providers.edit');
      }
    }
    openCanvas();
  }
  ...
  function saveModal() {
    ...
    var req;
    if (editingId) {
      req = request('/community/admin/rss-providers/' + encodeURIComponent(editingId), {
        method: 'PATCH',
        body: body
      });
    } else {
      ...
      req = request('/community/admin/rss-providers', { method: 'POST', body: body });
    }
    req.then(function () {
  ...
  function loadList() {
    ...
    return request('/community/admin/rss-providers' + qs).then(function (data) {
    ...
    if (tb) {
      tb.addEventListener('click', function (ev) {
        ...
        if (delBtn) {
          ...
          request('/community/admin/rss-providers/' + encodeURIComponent(id), { method: 'DELETE' })
            .then(function () {
