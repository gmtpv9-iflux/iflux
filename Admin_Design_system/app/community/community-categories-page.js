...
(function () {
  ...
  function loadList() {
    ...
    return request('/community/admin/categories' + qs).then(function (data) {
  ...
  function saveForm() {
    ...
    var p = editingId
      ? request('/community/admin/categories/' + encodeURIComponent(editingId), { method: 'PUT', body: payload })
      : request('/community/admin/categories', { method: 'POST', body: payload });
    p.then(function () {
      closeModal();
  ...
  function deleteItem(id) {
    ...
    request('/community/admin/categories/' + encodeURIComponent(id), { method: 'DELETE' })
      .then(function () {
