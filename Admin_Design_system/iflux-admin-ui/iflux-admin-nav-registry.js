...
(function (global) {
  ...
  var sidebar = [
    ...
    { type: 'item', key: "community-author-list", routeKey: "community-author-list", label: "Danh sách tác giả", icon: "ti-users" },
    ...
    { type: 'group', label: "Câu chuyện" },
    { type: 'item', key: "cau-chuyen-list", routeKey: "cau-chuyen-list", label: "Danh sách câu chuyện", icon: "ti-books" },
