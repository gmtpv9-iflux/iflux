...
(function (global) {
  ...
  var HREF_PERM = [
    ...
    { re: /\/admin\/news\/overview|\/admin\/cong-dong\/content\/dashboard/, p: 'news.content_dashboard.view' },
    { re: /\/admin\/news\/articles|\/admin\/news\/edit|\/admin\/cong-dong\/danh-sach-bai-viet|\/admin\/cong-dong\/content\/edit|\/admin\/community\/articles/, p: 'news.articles.view' },
    { re: /\/admin\/news\/categories|\/admin\/cong-dong\/categories/, p: 'news.categories.view' },
    { re: /\/admin\/news\/rss-sources|\/admin\/cong-dong\/nguon-rss/, p: 'news.rss_providers.view' },
    { re: /\/admin\/news\/rss-category-sync|\/admin\/cong-dong\/dong-bo-danh-muc/, p: 'news.rss_category_sync.view' },
    { re: /\/admin\/news\/rss-article-schema|\/admin\/cong-dong\/dong-bo-cau-truc-bai-viet/, p: 'news.rss_article_schema.view' },
    { re: /\/admin\/news\/topic-moderation|\/admin\/community\/topic-moderation|\/admin\/cong-dong\/chu-de-moderation|\/community\/stories|\/community\/chu-de-moderation/, p: 'news.stories.view' },
    { re: /\/admin\/news\/comments|\/admin\/community\/comments|\/admin\/cong-dong\/comments/, p: 'news.comments.view' },
    { re: /\/admin\/news\/reports|\/admin\/community\/reports|\/admin\/cong-dong\/reports/, p: 'news.reports.view' },
    { re: /\/admin\/news\/experts|\/admin\/cong-dong\/experts|\/community\/experts/, p: 'news.experts.view' },
    { re: /\/admin\/news\/topics|\/admin\/cong-dong\/danh-sach-chu-de|\/admin\/chu-de\/registry|\/story\/registry|\/chu-de\/registry/, p: 'stories.registry.view' },
  ...
  var PAGE_PERM = {
    'dashboard-index': 'dashboard.overview.view',
    ...
    'system-platform-layers': 'system.platform_layers.view',
    'system-feature-flags': 'system.feature_flags.view',
    'system-maintenance': 'system.maintenance.view',
    'system-audit': 'access.audit.view',
    'users-list': 'users.list.view',
    'users-export': 'users.list.export',
    'subscription-entitlements': 'subscription.entitlements.view',
    'req-partnership': 'requests.partnership.view',
    'req-withdrawals': 'requests.withdrawals.view',
    'req-features': 'requests.features.view',
    'req-bugs': 'requests.bugs.view',
    'orders-list': 'subscription.transactions.view',
    'orders-add': 'subscription.transactions.view',
    'orders-edit': 'subscription.transactions.view',
    'subscription-plans': 'subscription.plans.view',
    'subscription-plan-add': 'subscription.plans.view',
    'loyalty-promo-list': 'subscription.loyalty.view',
    'loyalty-promo-add': 'subscription.loyalty.view',
    'loyalty-promo-usage': 'subscription.loyalty.view',
    'loyalty-membership-list': 'subscription.loyalty.view',
    'news-content-dashboard': 'news.content_dashboard.view',
    'news-content-index': 'news.articles.view',
    'news-categories': 'news.categories.view',
    'news-chu-de-list': 'stories.registry.view',
    'news-comments': 'news.comments.view',
    'news-chu-de-moderation': 'news.stories.view',
    'news-reports': 'news.reports.view',
    'news-rss-providers': 'news.rss_providers.view',
    'news-rss-category-sync': 'news.rss_category_sync.view',
    'news-rss-article-schema': 'news.rss_article_schema.view',
    'news-experts': 'news.experts.view',
    'cau-chuyen-list': 'stories.registry.view',
    'cau-chuyen-detail': 'stories.cau_chuyen_detail.view',
    'chu-de-detail': 'stories.detail.view',
    'chu-de-mapping': 'stories.mapping.view',
    'chu-de-analytics': 'stories.analytics.view',
    'notifications-push': 'notifications.push.view',
    'notifications-in-app': 'notifications.in_app.view',
    'notifications-email': 'notifications.email.view',
    'notifications-history': 'notifications.history.view',
    'system-announcements': 'notifications.templates.view',
    'market-stocks': 'market.stocks.view',
    'market-ecosystems-index': 'market.ecosystems.view',
    'market-sectors-index': 'market.sectors.view',
    'market-lot-threshold': 'market.lot_threshold.view',
    'market-cau-hinh-thoi-gian': 'system.core_setup.view',
    'data-sources': 'data.sources.view',
    'market-stock-schema': 'data.sources.view',
    'market-sync-history': 'data.sources.view',
    'market-ranking': 'market.ranking.view',
    'market-formulas': 'market.formulas.view',
    'market-ops-feed-health': 'market_ops.feed_health.view',
    'market-ops-sessions': 'market_ops.sessions.view',
    'market-ops-missing-ticks': 'market_ops.missing_ticks.view',
    'market-ops-corrections': 'market_ops.corrections.view',
    'data-etl-jobs': 'data.etl_jobs.view',
    'data-pipeline': 'data.pipeline.view',
    'data-quality': 'data.quality.view',
    'data-dictionary': 'data.dictionary.view',
    'data-reconciliation': 'data.reconciliation.view',
    'metadata-sector-types': 'metadata.sector_types.view',
    'metadata-enums': 'metadata.enums.view',
    'metadata-themes': 'metadata.themes.view',
    'metadata-chu-de-lifecycle': 'metadata.story_lifecycle.view',
    'marketing-seo-system': 'marketing.seo_system.view',
    'marketing-seo-pages': 'marketing.seo_pages.view',
    'marketing-onboarding': 'marketing.onboarding.view',
    'ai-prompts': 'ai.prompts.view',
    'ai-prompt-detail': 'ai.prompts.view',
    'ai-logs': 'ai.logs.view',
    'ai-cost': 'ai.cost.view',
    'ai-quality': 'ai.quality.view',
    'analytics-users': 'dashboard.overview.view',
    'analytics-chu-de': 'stories.analytics.view',
    'analytics-revenue': 'subscription.transactions.view',
    'analytics-funnel': 'dashboard.overview.view'
  };
